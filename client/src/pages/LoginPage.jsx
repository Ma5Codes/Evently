      ...
      <div className="bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl">
        <form className="flex flex-col items-center" onSubmit={loginUser}>
          ...
          <div className="input relative">
            ...
            />
            <div onClick={() => setShowPassword((prev) => !prev)} className="cursor-pointer absolute right-2 top-1/2 transform -translate-y-1/2">
              {showPassword ? (
          ...
          <div className="w-full mt-4">
            <button type="button" className="w-full bg-blue-600 text-white py-2 rounded-md mb-2">
              Continue with Google
            </button>
            <button type="button" className="w-full bg-gray-800 text-white py-2 rounded-md">
